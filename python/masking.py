...
class Masking:
  ...
  lower_zero_at_20: signal.Numerical = -2
  lower_zero_at_80: signal.Numerical = -6
  upper_zero_at_20: signal.Numerical = 2
  upper_zero_at_80: signal.Numerical = 10

  onset_width: signal.Numerical = 10
  onset_peak: signal.Numerical = 6
  max_mask: signal.Numerical = 20
  ...
  def __post_init__(self):
    ...
    setattr(
        ...
        jax.jit(
            jax.vmap(full_masking_multi_maskers_multi_probes, (None, 1), 1)
        ),
    )
  ...
  def partial_loudness(
      self, energy_channels_db: signal.Channels
  ) -> signal.Channels:
